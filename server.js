...
const BOT_NAME = process.env.BOT_NAME || "ZAINXTECH - MD";
const OWNER_NAME = process.env.OWNER_NAME || "ZAIN";

const MENU_IMAGE_URL = process.env.MENU_IMAGE_URL || "https://i.ibb.co/4vgx6dC/jawadmd.jpg";
...
const AUTO_STATUS_MSG = process.env.AUTO_STATUS_MSG || "YOUR STATUS HAS BEEN SEEN BY ZAINXTECH - MD🫶🏻";
const DEV = process.env.DEV || 'ZAIN';
            ...
            case 'menu1':
                ...
                await conn.sendMessage(from, {
                    ...
                    forwardedNewsletterMessageInfo: {
                        ...
                        newsletterName: "𝙕𝙖𝙞𝙣𝙓𝙏𝙚𝙘𝙝",
                        serverMessageId: 200
                    },
                        externalAdReply: {
                            title: "📃 𝙕𝙖𝙞𝙣𝙓𝙏𝙚𝙘𝙝 Command Menu",
